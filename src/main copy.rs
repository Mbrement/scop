...
//                         break 'main_loop;
//                     }
// 					else if keycode == events::SDLK_w {
// 							helper::polygon_mode(helper::PolygonMode::Line);
// 						}
// 					else if keycode == events::SDLK_f {
// 						helper::polygon_mode(helper::PolygonMode::Fill);
// 					}	
// 					else if keycode == events::SDLK_p {
...
//         win.swap_window();
//     }
// 	win.set_title("ending");

// 	// Print the time taken to run the program
// 	println!("Exiting after {} ms", chrono::DateTime::timestamp_millis(&self::Utc::now()) - start);
// }
